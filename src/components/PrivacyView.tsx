      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-8 md:p-10 shadow-xs space-y-10">
          ...
          <div>
            ...
            <p className="font-sans text-sm text-gray-600 leading-relaxed">
              If you have any questions, wish to raise a Data Subject Access Request (DSAR), or have questions about how we securely interface with DVLA data, please email our designated Data Protection Officer at <span className="font-mono text-red-600 font-semibold">compliance@vinpremium.uk</span>.
            </p>
          </div>
        ...
        <div className="mt-10 text-center flex items-center justify-center space-x-2 text-gray-400 text-xs font-sans">
          ...
          <span>vinpremium.uk is registered with the Information Commissioner's Office (ICO) under registration number ZA82193.</span>
        </div>
