...
export function generateSimulatedReport(query: string, type: "vin" | "plate" = "plate"): VehicleReport {
  ...
  // Database of 6 detailed demo cars with varied statuses
  const demoCars: Record<string, Partial<VehicleReport>> = {
    ...
    // 3. Audi A4 Avant - Active Outstanding Finance
    "LV70ABC": {
      make: "Audi",
      ...
      score: 82,
      stolenStatus: "CLEAN",
      financeOutstanding: "YES", // Flagged!
      writeOffStatus: "CLEAN",
      scrappedStatus: "NO",
      importedStatus: "NO",
      vicSubject: "NO",
      ...
      accidentHistory: [],
      recalls: [],
      marketValueMin: 18400,
      marketValueMax: 19900,
      roadTaxStatus: "Taxed",
      roadTaxExpiry: "30/09/2026"
    },

    // 4. Ford Fiesta - Cosmetic Write-off Category N
    "GJ18XYZ": {
      make: "Ford",
      ...
      stolenStatus: "CLEAN",
      financeOutstanding: "NO",
      writeOffStatus: "CAT N", // Cosmetic write-off!
      scrappedStatus: "NO",
      importedStatus: "NO",
      vicSubject: "NO",
      previousOwners: 3,
      accidentHistory: [
        {
          date: "14/05/2022",
          severity: "Minor",
          description: "Rear bumper cosmetic impact, professionally repaired by approved insurance workshop.",
          pointOfImpact: "Rear Left Corner",
          repaired: true
        }
      ],
      recalls: [
        {
          date: "10/10/2019",
          campaignNumber: "R/2019/310",
          component: "Steering Column Column Bolt",
          description: "Check torque parameters on intermediate steering joint.",
          status: "Remedied"
        }
      ],
      marketValueMin: 6800,
      marketValueMax: 7600,
      roadTaxStatus: "Taxed",
      roadTaxExpiry: "31/12/2026"
    },

    // 5. Toyota Yaris - Pristine Super Saver Hybrid
    "HG21HBY": {
      make: "Toyota",
      ...
      accidentHistory: [],
      recalls: [],
      marketValueMin: 14200,
      marketValueMax: 15400,
      roadTaxStatus: "Taxed",
      roadTaxExpiry: "30/06/2027"
    },

    // 6. Range Rover Velar - Structural write-off + Outstanding finance
    "RO67VLR": {
      make: "Land Rover",
      ...
      score: 55,
      stolenStatus: "CLEAN",
      financeOutstanding: "YES", // Double Flagged!
      writeOffStatus: "CAT S", // Structural write-off!
      scrappedStatus: "NO",
      importedStatus: "NO",
      vicSubject: "NO",
      previousOwners: 4,
      accidentHistory: [
        {
          date: "18/11/2020",
          severity: "Severe",
          description: "Front end structure impact. Rebuilt by non-dealer insurance contractor.",
          pointOfImpact: "Front Radiator & Subframe",
          repaired: true
        }
      ],
      recalls: [
        {
          date: "09/11/2018",
          campaignNumber: "R/2018/195",
          component: "Fuel Rail End Cap",
          description: "Inspect engine fuel rail sealing caps for weeping or leaks.",
          status: "Remedied"
        }
      ],
      marketValueMin: 19500,
      marketValueMax: 21500,
      roadTaxStatus: "SORN",
      roadTaxExpiry: "31/10/2025"
    }
  };
